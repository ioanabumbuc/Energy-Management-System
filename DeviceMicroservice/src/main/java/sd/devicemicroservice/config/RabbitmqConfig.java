package sd.devicemicroservice.config;
...
public class RabbitmqConfig {
    static final String topicExchangeName = "deviceExchange";

    static final String queueName = "deviceQueue";
    ...
    Binding binding(Queue queue, DirectExchange directExchange) {
        return BindingBuilder.bind(queue).to(directExchange).with("deviceQueue");
    }
